...
SET CFLAGS=-I- -i ../../libraries -i ../DolphinPack -i ../CommonCodes -Cpp_exceptions off -enum int -O4,s -use_lmw_stmw on -fp hard -rostr -sdata 0 -sdata2 0 -maxerrors 1
